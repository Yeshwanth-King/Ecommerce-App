    ...
    <footer className="bg-gray-900 text-gray-300 mt-auto">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-white text-lg font-bold mb-4">E-Commerce Store</h3>
            <p className="text-sm mb-4">
              Your trusted destination for premium quality products. Shop with confidence.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="text-sm flex items-center gap-1">
            Made with <Heart className="w-4 h-4 text-red-500 fill-current" /> for amazing customers
          </p>
        </div>
      </div>
    </footer>
